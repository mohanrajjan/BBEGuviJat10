...
public class SearchByDepartment extends EngineClass {
	...
	public void shopByDepart(String CardNumber, String ExpirationDate, String CVV, String Searchproduct) {
		...
		waitImplicit(3);
		//lp.validLogin(openProp("vlogemail"), openProp("vlogpass"), openProp("vlogfn"));
		pl.searchByDepart();
		cp.pickupatstore();
		lp.guest();
		co.gotopaymentpage();
